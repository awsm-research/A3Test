...
class LitModel(pl.LightningModule):
    ...
    def generate_text(self, text, eval_beams, early_stopping = True, max_len = 800):
...
# checkpoint = ModelCheckpoint(dirpath="checkpoint_files_3/",monitor="val_loss",mode="min")
# if(epochsTakenEn!=0):
